...
<body>
    ...
    <main role="main" class="ml-sm-auto col-lg-11">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2" style="padding-left: 200px;">THAY ĐỔI MẬT KHẨU</h1>
        </div>
        <form class="js-form-submit-data" action="#" method="POST">
            ...
            <div class="form-group row mt-5">
                ...
                <div class="col-md-8">
                    <button type="submit" name="btnsubmit" class="btn btn-primary btn-lg mb-2 btn-block">Đổi mật khẩu</button>
                </div>
            </div>
