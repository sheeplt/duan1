...
<head>
    ...
    <link rel="stylesheet" href="chat_app_php-main/assets/style_HS.css">
    ...
    <div class="super_container">
        ...
        <header class="header d-flex flex-row">
                ...
                <nav class="main_nav_container">
                    <div class="main_nav">
                        <ul class="main_nav_list">
                            ...
                            <li class="main_nav_item">
                                <div class="qoute">
                                    <a href="HS.php?hoivadap">
                                        <img src="view/images/chat.png" style="width:25px; margin-bottom: 5px;"> 
                                        Hỏi & Đáp
                                    </a>
                                </div>
                            </li>
            ...
            <div class="header_side d-flex flex-row justify-content-center align-items-center">
                    <a class="dangxuat" href="HS.php?dangxuat" onclick="return confirm('Đăng xuất ?');">
            ...
            <div class="menu_inner menu_mm">
                <div class="menu menu_mm">
                    <ul class="menu_list menu_mm">
                        <li class="menu_item menu_mm"><a href="HS.php?page=trangchu">Trang chủ</a></li>
                        <li class="menu_item menu_mm"><a href="HS.php?page=ttcn">Xem thông tin cá nhân</a></li>
                        <li class="menu_item menu_mm"><a href="HS.php?page=lichhoc">Xem lịch học</a></li>
                        <li class="menu_item menu_mm"><a href="HS.php?hoivadap">Hỏi & Đáp</a></li>
                        <li class="menu_item menu_mm"><a href="index.php">Đăng xuất</a></li>
