...
if (isset($_COOKIE["ngaythang"]) & isset($_REQUEST["hientai"])) {
    ...
    echo header("refresh:0; url='HS.php?lichhoc'");
}
// lấy mã lớp
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="section_title text-center">
                    <h1 style="margin-bottom: 50px;">Lịch học theo tuần</h1>
                </div>
            </div>
        </div>
        ...
        <table style="width:99%; font-size: 20px ; text-align: center; margin: 5px; border : 1px solid black"
            ...
            <tr>
                ...
                <td id="thu2sang">
                    <?php
                    $table1 = $p->laylichchoHS1($ma, $ngay2);
                    while ($row1 = mysqli_fetch_assoc($table1)) {
                        ...
                        if ($row1["TrangThaiBuoiHoc"] == 0) {
                            echo "<br>";
                            echo "<p style='color: black; font-size: 13px;'>(Đang lên kế hoạch)</p>";
                        }
                        echo "<p style='font-size: 13px; color:black;'>Tiết học: ";
                        echo $row1["Tiet"] . "</p>";
                        echo "<p style='font-size: 13px; color:black;'>Giáo viên: <br>";
                        echo $row1["TenGV"] . "</p>";
                ...
                <td id="thu3sang">
                    <?php
                    $table1 = $p->laylichchoHS1($ma, $ngay3);
                    while ($row1 = mysqli_fetch_assoc($table1)) {
                        echo "<table  style='border : 1px solid black; background: #ADD8E6; margin: 10px -25px 10px 20px;'> <tr> <td>";
                        echo "<b style='font-size: 15px;'>";
                        echo $row1["TenLop"];
                ...
                <td id="thu4sang">
                    <?php
                    $table1 = $p->laylichchoHS1($ma, $ngay4);
                    while ($row1 = mysqli_fetch_assoc($table1)) {
                        echo "<table  style='border : 1px solid black; background: #ADD8E6; margin: 10px -25px 10px 20px;'> <tr> <td>";
                        echo "<b style='font-size: 15px;'>";
                        echo $row1["TenLop"];
                ...
                <td id="thu5sang">
                    <?php
                    $table1 = $p->laylichchoHS1($ma, $ngay5);
                    while ($row1 = mysqli_fetch_assoc($table1)) {
                        echo "<table  style='border : 1px solid black; background: #ADD8E6; margin: 10px -25px 10px 20px;'> <tr> <td>";
                        echo "<b style='font-size: 15px;'>";
                        echo $row1["TenLop"];
                ...
                <td id="thu6sang">
                    <?php
                    $table1 = $p->laylichchoHS1($ma, $ngay6);
                    while ($row1 = mysqli_fetch_assoc($table1)) {
                        echo "<table  style='border : 1px solid black; background: #ADD8E6; margin: 10px -25px 10px 20px;'> <tr> <td>";
                        echo "<b style='font-size: 15px;'>";
                        echo $row1["TenLop"];
                ...
                <td id="thu7sang">
                    <?php
                    $table1 = $p->laylichchoHS1($ma, $ngay7);
                    while ($row1 = mysqli_fetch_assoc($table1)) {
                        echo "<table  style='border : 1px solid black; background: #ADD8E6; margin: 10px -25px 10px 20px;'> <tr> <td>";
                        echo "<b style='font-size: 15px;'>";
                        echo $row1["TenLop"];
                ...
                <td id="cnsang">
                    <?php
                    $table1 = $p->laylichchoHS1($ma, $ngaycn);
                    while ($row1 = mysqli_fetch_assoc($table1)) {
                        echo "<table  style='border : 1px solid black; background: #ADD8E6; margin: 10px -25px 10px 20px;'> <tr> <td>";
                        echo "<b style='font-size: 15px;'>";
                        echo $row1["TenLop"];
            ...
            <tr>
                ...
                <td id="thu2chieu">
                    <?php
                    $table2 = $p->laylichchoHS2($ma, $ngay2);
                ...
                <td id="thu3chieu">
                    <?php
                    $table2 = $p->laylichchoHS2($ma, $ngay3);
                    while ($row2 = mysqli_fetch_assoc($table2)) {
                        echo "<table  style='border : 1px solid black; background: #ADD8E6; margin: 10px -25px 10px 20px;'> <tr> <td>";
                        echo "<b style='font-size: 15px;'>";
                        echo $row2["TenLop"];
                ...
                <td id="thu4chieu">
                    <?php
                    $table2 = $p->laylichchoHS2($ma, $ngay4);
                    while ($row2 = mysqli_fetch_assoc($table2)) {
                        echo "<table  style='border : 1px solid black; background: #ADD8E6; margin: 10px -25px 10px 20px;'> <tr> <td>";
                        echo "<b style='font-size: 15px;'>";
                        echo $row2["TenLop"];
                ...
                <td id="thu5chieu">
                    <?php
                    $table2 = $p->laylichchoHS2($ma, $ngay5);
                    while ($row2 = mysqli_fetch_assoc($table2)) {
                        echo "<table  style='border : 1px solid black; background: #ADD8E6; margin: 10px -25px 10px 20px;'> <tr> <td>";
                        echo "<b style='font-size: 15px;'>";
                        echo $row2["TenLop"];
                ...
                <td id="thu6chieu">
                    <?php
                    $table2 = $p->laylichchoHS2($ma, $ngay6);
                    while ($row2 = mysqli_fetch_assoc($table2)) {
                        echo "<table  style='border : 1px solid black; background: #ADD8E6; margin: 10px -25px 10px 20px;'> <tr> <td>";
                        echo "<b style='font-size: 15px;'>";
                        echo $row2["TenLop"];
                ...
                <td id="thu7chieu">
                    <?php
                    $table2 = $p->laylichchoHS2($ma, $ngay7);
                    while ($row2 = mysqli_fetch_assoc($table2)) {
                        echo "<table  style='border : 1px solid black; background: #ADD8E6; margin: 10px -25px 10px 20px;' > <tr> <td>";
                        echo "<b style='font-size: 15px;'>";
                        echo $row2["TenLop"];
                ...
                <td id="thucnchieu">
                    <?php
                    $table2 = $p->laylichchoHS2($ma, $ngaycn);
                    while ($row2 = mysqli_fetch_assoc($table2)) {
                        echo "<table  style='border : 1px solid black; background: #ADD8E6; margin: 10px -25px 10px 20px;'> <tr> <td>";
                        echo "<b style='font-size: 15px;'>";
                        echo $row2["TenLop"];
            ...
            <tr>
                ...
                <td id="thu2toi">
                    <?php
                    $table2 = $p->laylichchoHS3($ma, $ngay2);
                    while ($row2 = mysqli_fetch_assoc($table2)) {
                        echo "<table  style='border : 1px solid black; background: #ADD8E6; margin: 10px -25px 10px 20px;'> <tr> <td>";
                        echo "<b style='font-size: 15px;'>";
                        echo $row2["TenLop"];
                ...
                <td id="thu3toi">
                    <?php
                    $table2 = $p->laylichchoHS3($ma, $ngay3);
                    while ($row2 = mysqli_fetch_assoc($table2)) {
                        echo "<table  style='border : 1px solid black; background: #ADD8E6; margin: 10px -25px 10px 20px;'> <tr> <td>";
                        echo "<b style='font-size: 15px;'>";
                        echo $row2["TenLop"];
                ...
                <td id="thu4toi">
                    <?php
                    $table2 = $p->laylichchoHS3($ma, $ngay4);
                    while ($row2 = mysqli_fetch_assoc($table2)) {
                        echo "<table  style='border : 1px solid black; background: #ADD8E6; margin: 10px -25px 10px 20px;'> <tr> <td>";
                        echo "<b style='font-size: 15px;'>";
                        echo $row2["TenLop"];
                ...
                <td id="thu5toi">
                    <?php
                    $table2 = $p->laylichchoHS3($ma, $ngay5);
                    while ($row2 = mysqli_fetch_assoc($table2)) {
                        echo "<table  style='border : 1px solid black; background: #ADD8E6; margin: 10px -25px 10px 20px;'> <tr> <td>";
                        echo "<b style='font-size: 15px;'>";
                        echo $row2["TenLop"];
                ...
                <td id="thu6toi">
                    <?php
                    $table2 = $p->laylichchoHS3($ma, $ngay6);
                    while ($row2 = mysqli_fetch_assoc($table2)) {
                        echo "<table  style='border : 1px solid black; background: #ADD8E6; margin: 10px -25px 10px 20px;'> <tr> <td>";
                        echo "<b style='font-size: 15px;'>";
                        echo $row2["TenLop"];
                ...
                <td id="thu7toi">
                    <?php
                    $table2 = $p->laylichchoHS3($ma, $ngay7);
                    while ($row2 = mysqli_fetch_assoc($table2)) {
                        echo "<table  style='border : 1px solid black; background: #ADD8E6; margin: 10px -25px 10px 20px;' > <tr> <td>";
                        echo "<b style='font-size: 15px;'>";
                        echo $row2["TenLop"];
                ...
                <td id="thucntoi">
                    <?php
                    $table2 = $p->laylichchoHS3($ma, $ngaycn);
                    while ($row2 = mysqli_fetch_assoc($table2)) {
                        echo "<table  style='border : 1px solid black; background: #ADD8E6; margin: 10px -25px 10px 20px;'> <tr> <td>";
                        echo "<b style='font-size: 15px;'>";
                        echo $row2["TenLop"];
